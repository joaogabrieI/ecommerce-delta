...
<body>
    ...
    {{$slot}}
    <footer>
        <div class="d-flex justify-content-around company-info">
            <div class="d-flex justify-content-center align-items-center">
                <img src="img/icon.png" alt="" />
            </div>

            <p class="w-25 d-flex justify-content-center align-items-center mission-text">
            ...
            <div class="footer-contact d-flex flex-column justify-content-center">
                <h3 class="">Contato</h3>
                <div class="d-flex">
