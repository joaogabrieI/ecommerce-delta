        ...
        <div class="card-desc">
            ...
            <div class="card-desc-prod">
                ...
                <div class="alinhar-dados">
                    <div class="pagamentro">
                        <i class='bx bx-credit-card'></i>
                        <div class="valores">
                            <p class="credito">
                            R$ {{number_format($product->PRODUTO_PRECO, 2, ',', '.')}}</p>
                            <span>
                            R$ {{ number_format($precoComDesconto, 2, ',', '.') }} com desconto
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="socials">
                ...
                <a href="#" class="icons-redes">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white"
                        class="bi bi-facebook teste ms-4" viewBox="0 0 16 16">
                        <path
                ...
                <a href="#" class="icons-redes">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white"
                        class="bi bi-instagram teste ms-4" viewBox="0 0 16 16">
                        <path
                ...
                <a href="#" class="icons-redes">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white"
                        class="bi bi-twitter-x teste ms-4" viewBox="0 0 16 16">
                        <path
